...
namespace Wandala.HabboHotel.Groups
{
    public class GroupManager
    {
        private static readonly ILog log = LogManager.GetLogger("Wandala.HabboHotel.Groups.GroupManager");
        ...
        {
            Group = new Group(0, Name, Description, Badge, RoomId, Player.Id, (int)WandalaEnvironment.GetUnixTimestamp(), 0, Colour1, Colour2, 0, false);
