...
namespace Wandala.HabboHotel.Items.Wired.Boxes.Effects
{
    internal class MoveAndRotateBox : IWiredItem, IWiredCycle
    {
        ...
        public bool Execute(params object[] Params)
        {
            ...
            if (this._next == 0 || this._next < WandalaEnvironment.Now())
                this._next = WandalaEnvironment.Now() + this.Delay;
        ...
        public bool OnCycle()
        {
            ...
            long Now = WandalaEnvironment.Now();
            if (_next < Now)
            {
