...
using Wandala.HabboHotel.Items.Interactor;
...
namespace Wandala.HabboHotel.Items
{
    ...
    public class Item
    {
        ...
        {
            ItemData Data = null;
            if (WandalaEnvironment.GetGame().GetItemManager().GetItem(BaseItem, out Data))
            {
                this.Id = Id;
                this.RoomId = RoomId;
                this._room = Room;
                ...
                this.UserID = Userid;
                this.Username = WandalaEnvironment.GetUsernameById(Userid);
                                            ...
                                            if (ItemTeleporterFinder.IsTeleLinked(Id, GetRoom()))
                                            {
                                                ...
                                                if (true)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        //WandalaEnvironment.GetGame().GetRoomManager().AddTeleAction(new TeleUserData(User.GetClient().GetMessageHandler(), User.GetClient().GetHabbo(), RoomId, TeleId));
                                                    }
        ...
        public ItemData GetBaseItem()
        {
            ...
            {
                ItemData I = null;
                if (WandalaEnvironment.GetGame().GetItemManager().GetItem(this.BaseItem, out I))
                    this._data = I;
            }
