...
using Wandala.Communication.Packets;
...
using Wandala.HabboHotel.Rooms.Chat;
using Wandala.HabboHotel.Talents;
using Wandala.HabboHotel.Bots;
using Wandala.HabboHotel.Cache;
using Wandala.HabboHotel.Rewards;
...
namespace Wandala.HabboHotel
{
    public class Game
    {
        private static readonly ILog log = LogManager.GetLogger("Wandala.HabboHotel.Game");
        ...
        private void GameCycle()
        {
            while (this._cycleActive)
            {
                ...
                WandalaEnvironment.GetGame().GetRoomManager().OnCycle();
                WandalaEnvironment.GetGame().GetClientManager().OnCycle();
