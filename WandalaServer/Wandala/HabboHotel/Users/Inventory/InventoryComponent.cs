...
using Wandala.HabboHotel.Users.Inventory.Pets;
...
namespace Wandala.HabboHotel.Users.Inventory
{
    public class InventoryComponent
    {
        ...
        {
            return WandalaEnvironment.GetGame().GetClientManager().GetClientByUserID(_userId);
        }
