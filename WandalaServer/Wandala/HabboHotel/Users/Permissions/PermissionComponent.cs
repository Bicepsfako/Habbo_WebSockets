...
namespace Wandala.HabboHotel.Users.Permissions
{
    /// <summary>
    ...
    public sealed class PermissionComponent
    {
        ...
        public bool Init(Habbo Player)
        {
            ...
            this._permissions.AddRange(WandalaEnvironment.GetGame().GetPermissionManager().GetPermissionsForPlayer(Player));
            this._commands.AddRange(WandalaEnvironment.GetGame().GetPermissionManager().GetCommandsForPlayer(Player));
            return true;
        }
