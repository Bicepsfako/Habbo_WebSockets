...
namespace Wandala.HabboHotel.Users.Process
{
    sealed class ProcessComponent
    {
        private static readonly ILog log = LogManager.GetLogger("Wandala.HabboHotel.Users.Process.ProcessComponent");
        ...
        public void Run(object State)
        {
            try
            {
                ...
                if (this._player.GetClient() != null)
                    WandalaEnvironment.GetGame().GetAchievementManager().ProgressAchievement(this._player.GetClient(), "ACH_AllTimeHotelPresence", 1);
