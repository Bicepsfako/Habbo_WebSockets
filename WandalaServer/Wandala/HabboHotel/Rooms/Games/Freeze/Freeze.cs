...
using Wandala.Communication.Packets.Outgoing.Rooms.Freeze;
using Wandala.HabboHotel.Rooms.Games.Teams;
using Wandala.HabboHotel.Items.Wired;

namespace Wandala.HabboHotel.Rooms.Games.Freeze
{
    public class Freeze
    {
        private Room _room;
        ...
        {
            return ExitTeleports.Values.ToList()[WandalaEnvironment.GetRandomNumber(0, ExitTeleports.Count - 1)];
        }
