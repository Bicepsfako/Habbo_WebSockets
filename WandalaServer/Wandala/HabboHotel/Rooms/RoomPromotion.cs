...
namespace Wandala.HabboHotel.Rooms
{
    public class RoomPromotion
    {
        ...
        public RoomPromotion(string Name, string Desc, int CategoryId)
        {
            ...
            this._timestampStarted = WandalaEnvironment.GetUnixTimestamp();
            this._timestampExpires = (WandalaEnvironment.GetUnixTimestamp()) + (Convert.ToInt32(WandalaEnvironment.GetSettingsManager().TryGetValue("room.promotion.lifespan")) * 60);
        ...
        {
            get { return (this.TimestampExpires - WandalaEnvironment.GetUnixTimestamp()) < 0; }
        }

        public int MinutesLeft
        {
            get { return Convert.ToInt32(Math.Ceiling((this.TimestampExpires - WandalaEnvironment.GetUnixTimestamp()) / 60)); }
        }
