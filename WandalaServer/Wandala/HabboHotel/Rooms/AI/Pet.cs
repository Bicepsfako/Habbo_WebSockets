...
using Wandala.Communication.Packets.Outgoing.Rooms.AI.Pets;

namespace Wandala.HabboHotel.Rooms.AI
{
    public class Pet
    {
        public int PetId;
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = WandalaEnvironment.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (WandalaEnvironment.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((WandalaEnvironment.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return WandalaEnvironment.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }
