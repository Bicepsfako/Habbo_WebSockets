...
namespace Wandala.HabboHotel.Rooms.AI.Types
{
    class BartenderBot : BotAI
    {
        ...
        public override void OnUserSay(RoomUser User, string Message)
        {
            ...
            BotResponse Response = WandalaEnvironment.GetGame().GetBotManager().GetResponse(GetBotData().AiType, Message);
            if (Response == null)
                return;
        ...
        public override void OnTimerTick()
        {
            ...
            if (SpeechTimer <= 0)
            {
                if (GetBotData().RandomSpeech.Count > 0)
                {
                    ...
                    string String = WandalaEnvironment.GetGame().GetChatManager().GetFilter().CheckMessage(Speech.Message);
