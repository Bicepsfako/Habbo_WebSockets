                ...
                case "push":
                    {
                        ...
                        using (IQueryAdapter dbClient = WandalaEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("PushEnabled", WandalaEnvironment.BoolToEnum(Room.PushEnabled));
                            dbClient.RunQuery();
                        }
                ...
                case "spush":
                    {
                        ...
                        using (IQueryAdapter dbClient = WandalaEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("PushEnabled", WandalaEnvironment.BoolToEnum(Room.SPushEnabled));
                            dbClient.RunQuery();
                        }
                ...
                case "spull":
                    {
                        ...
                        using (IQueryAdapter dbClient = WandalaEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("PullEnabled", WandalaEnvironment.BoolToEnum(Room.SPullEnabled));
                            dbClient.RunQuery();
                        }
                ...
                case "pull":
                    {
                        ...
                        using (IQueryAdapter dbClient = WandalaEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("PullEnabled", WandalaEnvironment.BoolToEnum(Room.PullEnabled));
                            dbClient.RunQuery();
                        }
                ...
                case "enables":
                    {
                        ...
                        using (IQueryAdapter dbClient = WandalaEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("EnablesEnabled", WandalaEnvironment.BoolToEnum(Room.EnablesEnabled));
                            dbClient.RunQuery();
                        }
                ...
                case "respect":
                    {
                        ...
                        using (IQueryAdapter dbClient = WandalaEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("RespectNotificationsEnabled", WandalaEnvironment.BoolToEnum(Room.RespectNotificationsEnabled));
                            dbClient.RunQuery();
                        }
                ...
                case "morphs":
                    {
                        ...
                        using (IQueryAdapter dbClient = WandalaEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("PetMorphsAllowed", WandalaEnvironment.BoolToEnum(Room.PetMorphsAllowed));
                            dbClient.RunQuery();
                        }
