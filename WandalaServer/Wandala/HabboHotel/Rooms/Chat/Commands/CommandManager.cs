...
using Wandala.HabboHotel.Rooms.Chat.Commands.User;
using Wandala.HabboHotel.Rooms.Chat.Commands.User.Fun;
using Wandala.HabboHotel.Rooms.Chat.Commands.Moderator;
using Wandala.HabboHotel.Rooms.Chat.Commands.Moderator.Fun;
using Wandala.HabboHotel.Rooms.Chat.Commands.Administrator;
...
using Wandala.HabboHotel.Rooms.Chat.Commands.Events;
using Wandala.HabboHotel.Items.Wired;


namespace Wandala.HabboHotel.Rooms.Chat.Commands
{
    public class CommandManager
    {
        ...
        public void LogCommand(int UserId, string Data, string MachineId)
        {
            using (IQueryAdapter dbClient = WandalaEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                ...
                dbClient.AddParameter("Timestamp", WandalaEnvironment.GetUnixTimestamp());
                dbClient.RunQuery();
            }
        }
