...
namespace Wandala.HabboHotel.Rooms.Chat.Styles
{
    public sealed class ChatStyleManager
    {
        private static readonly ILog log = LogManager.GetLogger("Wandala.HabboHotel.Rooms.Chat.Styles.ChatStyleManager");
