...
using Wandala.HabboHotel.Items.Wired.Boxes.Triggers;

using Wandala.HabboHotel.Items.Wired.Boxes.Effects;
using Wandala.HabboHotel.Items.Wired.Boxes.Conditions;
using Wandala.Database.Interfaces;
using System.Drawing;
using Wandala.HabboHotel.Items.Wired.Boxes;

namespace Wandala.HabboHotel.Rooms.Instance
{
