...
using log4net;
using Wandala.Communication.ConnectionManager.Socket_Exceptions;

namespace Wandala.Communication.ConnectionManager
{
    public class SocketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Wandala.Communication.ConnectionManager");
