...
namespace Wandala.Communication.RCON
{
    public class RCONConnection
    {
        ...
        private static readonly ILog log = LogManager.GetLogger("Wandala.Communication.RCON.RCONConnection");
        ...
        public void OnCallBack(IAsyncResult iAr)
        {
            try
            {
                ...
                if (!WandalaEnvironment.GetRCONSocket().GetCommands().Parse(data))
                {
