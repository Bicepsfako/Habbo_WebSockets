...
namespace Wandala.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        {
            return "[" + Header + "] BODY: " + (WandalaEnvironment.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return WandalaEnvironment.GetDefaultEncoding().GetString(ReadFixedValue());
        }
