...
namespace Wandala.Communication.Packets.Incoming.Rooms.AI.Pets
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Wandala.Communication.Packets.Incoming.Rooms.AI.Pets.PlacePetEvent");
        ...
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (Room.GetRoomUserManager().PetCount > Convert.ToInt32(WandalaEnvironment.GetSettingsManager().TryGetValue("room.pets.placement_limit")))
            {
