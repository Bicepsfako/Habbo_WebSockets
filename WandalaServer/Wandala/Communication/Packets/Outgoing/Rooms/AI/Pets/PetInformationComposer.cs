...
namespace Wandala.Communication.Packets.Outgoing.Rooms.AI.Pets
{
    class PetInformationComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.PetInformationMessageComposer)
        {
            ...
            if (!WandalaEnvironment.GetGame().GetRoomManager().TryGetRoom(Pet.RoomId, out Room))
                return;
            ...
            : base(ServerPacketHeader.PetInformationMessageComposer)
        {
           ...
           base.WriteString(Habbo.Username);
            ...
            base.WriteInteger(Habbo.Id);
            base.WriteInteger(Convert.ToInt32(Math.Floor((WandalaEnvironment.GetUnixTimestamp() - Habbo.AccountCreated) / 86400)));//How?
           base.WriteString(Habbo.Username);
            base.WriteInteger(1);//3 on hab
            base.WriteBoolean(false);
            base.WriteBoolean(false);
