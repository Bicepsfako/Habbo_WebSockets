...
namespace Wandala.Communication.Packets.Outgoing.Messenger
{
    class HabboSearchResultComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.HabboSearchResultMessageComposer)
        {
            ...
            {
                bool Online = (WandalaEnvironment.GetGame().GetClientManager().GetClientByUserID(Friend.UserId) != null);
            ...
            {
                bool Online = (WandalaEnvironment.GetGame().GetClientManager().GetClientByUserID(OtherUser.UserId) != null);
