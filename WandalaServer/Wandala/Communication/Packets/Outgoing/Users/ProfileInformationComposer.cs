...
namespace Wandala.Communication.Packets.Outgoing.Users
{
    class ProfileInformationComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.ProfileInformationMessageComposer)
        {
            ...
            base.WriteBoolean((WandalaEnvironment.GetGame().GetClientManager().GetClientByUserID(habbo.Id)) != null);
            ...
            foreach (Group group in groups)
            {
                ...
                base.WriteString(WandalaEnvironment.GetGame().GetGroupManager().GetColourCode(group.Colour1, true));
                base.WriteString(WandalaEnvironment.GetGame().GetGroupManager().GetColourCode(group.Colour2, false));
            ...
            base.WriteInteger(Convert.ToInt32(WandalaEnvironment.GetUnixTimestamp() - habbo.LastOnline)); // Last online
