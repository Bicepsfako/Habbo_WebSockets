...
namespace Wandala.Communication.Packets.Outgoing.Catalog
{
    public class CatalogPageComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.CatalogPageMessageComposer)
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else if (Item.Data.InteractionType == InteractionType.BOT)//Bots
                            {
                                ...
                                if (!WandalaEnvironment.GetGame().GetCatalog().TryGetBot(Item.ItemId, out CatalogBot))
            ...
            base.WriteInteger(WandalaEnvironment.GetGame().GetCatalog().GetPromotions().ToList().Count);//Count
            foreach (CatalogPromotion Promotion in WandalaEnvironment.GetGame().GetCatalog().GetPromotions().ToList())
            {
