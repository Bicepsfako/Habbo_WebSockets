...
using Wandala.Communication.Packets.Incoming.Catalog;
using Wandala.Communication.Packets.Incoming.Handshake;
using Wandala.Communication.Packets.Incoming.Navigator;
using Wandala.Communication.Packets.Incoming.Quests;
using Wandala.Communication.Packets.Incoming.Rooms.Avatar;
using Wandala.Communication.Packets.Incoming.Rooms.Chat;
using Wandala.Communication.Packets.Incoming.Rooms.Connection;
using Wandala.Communication.Packets.Incoming.Rooms.Engine;
using Wandala.Communication.Packets.Incoming.Rooms.Action;
using Wandala.Communication.Packets.Incoming.Users;
using Wandala.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Wandala.Communication.Packets.Incoming.Inventory.Purse;
using Wandala.Communication.Packets.Incoming.Sound;
using Wandala.Communication.Packets.Incoming.Misc;
using Wandala.Communication.Packets.Incoming.Inventory.Badges;
using Wandala.Communication.Packets.Incoming.Avatar;
using Wandala.Communication.Packets.Incoming.Inventory.Achievements;
using Wandala.Communication.Packets.Incoming.Inventory.Bots;
using Wandala.Communication.Packets.Incoming.Inventory.Pets;
using Wandala.Communication.Packets.Incoming.LandingView;
using Wandala.Communication.Packets.Incoming.Messenger;
using Wandala.Communication.Packets.Incoming.Groups;

using Wandala.Communication.Packets.Incoming.Rooms.Settings;
using Wandala.Communication.Packets.Incoming.Rooms.AI.Pets;
using Wandala.Communication.Packets.Incoming.Rooms.AI.Bots;
using Wandala.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Wandala.Communication.Packets.Incoming.Rooms.Furni;
using Wandala.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Wandala.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Wandala.Communication.Packets.Incoming.Help;
using Wandala.Communication.Packets.Incoming.Rooms.FloorPlan;
using Wandala.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Wandala.Communication.Packets.Incoming.Moderation;
using Wandala.Communication.Packets.Incoming.Inventory.Furni;
using Wandala.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Wandala.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Wandala.Communication.Packets.Incoming.Inventory.Trading;
using Wandala.Communication.Packets.Incoming.GameCenter;
using Wandala.Communication.Packets.Incoming.Marketplace;
using Wandala.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Wandala.Communication.Packets.Incoming.Talents;

namespace Wandala.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Wandala.Communication.Packets");
